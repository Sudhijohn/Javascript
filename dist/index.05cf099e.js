...
const createInitalState = ()=>{
    while(state.data.length < _config.MAX_NO_PROBLEM){
        const question = {
...
const updateStatus = (id, ans)=>{
    const question1 = state.data.find((question)=>question.id === id
    );
    if (!question1) return;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"11Iuu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"cq0aw":[function(require,module,exports) {
...
},{}],"ijVUu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _views = require("./views");
var _viewsDefault = parcelHelpers.interopDefault(_views);
